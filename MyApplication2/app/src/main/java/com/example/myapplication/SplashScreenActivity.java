...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private final static int LOGIN_REQUEST_CODE = 7171;//dummy number
...
//01
    ...
    private void showRegisterLayout() {
        ...
        TextInputEditText edit_first_name = (TextInputEditText)itemView.findViewById(R.id.edt_first_name);
        TextInputEditText edit_last_name = (TextInputEditText)itemView.findViewById(R.id.edt_last_name);
        TextInputEditText edit_phone = (TextInputEditText)itemView.findViewById(R.id.edt_phone_number);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
...

                {
                    ...
                    Toast.makeText(SplashScreenActivity.this, "please enter Phone", Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
